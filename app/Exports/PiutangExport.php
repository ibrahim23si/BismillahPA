...
class PiutangExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithEvents, ShouldAutoSize
{
    ...
    {
        return Piutang::whereBetween('tanggal', [$this->startDate, $this->endDate])
            ->orderBy('tanggal', 'asc')->get();
    }

    public function headings(): array
    {
        return ['No', 'Tanggal', 'Nama Debitur', 'Jenis Transaksi', 'No. Invoice', 'Nominal', 'Tgl Jatuh Tempo', 'Over Due', 'Status', 'Tgl Bayar', 'Cash Bayar', 'Transfer Bayar', 'Sisa'];
    }
    ...
    public function title(): string { return 'Piutang'; }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'DATA PIUTANG'); $sheet->mergeCells("A1:{$lastCol}1");
