{{-- resources/views/admin/keluar-material-utm/edit.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Data Keluar Material UTM') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.keluar-material-utm.update', $material->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex justify-end space-x-2 mt-6">
                            <a href="{{ route('admin.keluar-material-utm.index') }}"
