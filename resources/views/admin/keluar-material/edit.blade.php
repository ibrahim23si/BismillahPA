{{-- resources/views/admin/keluar-material/edit.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Data Keluar Material') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.keluar-material.update', $material->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_urut" id="nomor_urut"
                                    value="{{ old('nomor_urut', $material->nomor_urut) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="hari" id="hari"
                                    value="{{ old('hari', $material->hari) }}" min="1" max="31"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('hari')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal" id="tanggal"
                                    value="{{ old('tanggal', $material->tanggal->format('Y-m-d')) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('tanggal')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_tiket" id="nomor_tiket"
                                    value="{{ old('nomor_tiket', $material->nomor_tiket) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('nomor_tiket')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" name="nopol" id="nopol"
                                    value="{{ old('nopol', $material->nopol) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('nopol')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="transporter" id="transporter"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                    <option value="{{ old('transporter', $material->transporter) }}" selected>{{ old('transporter', $material->transporter) }}</option>
                                </select>
                                @error('transporter')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_customer" id="nama_customer"
                                    value="{{ old('nama_customer', $material->nama_customer) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('nama_customer')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="nama_barang" id="nama_barang"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                    <option value="{{ old('nama_barang', $material->nama_barang) }}" selected>{{ old('nama_barang', $material->nama_barang) }}</option>
                                </select>
                                @error('nama_barang')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="gross" id="gross"
                                    value="{{ old('gross', $material->gross) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                                @error('gross')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" id="netto"
                                    value="{{ number_format($material->netto, 2) }}" readonly
                            ...
                            <div>
                                ...
                                <input type="text" id="total_harga"
                                    value="{{ $material->total_harga ? 'Rp ' . number_format($material->total_harga, 0, ',', '.') : '-' }}"
                                    readonly
                                    class="mt-1 block w-full rounded-md bg-gray-100 border-gray-300 shadow-sm">
                            </div>
                            ...
                            <div class="md:col-span-3">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="2"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('keterangan', $material->keterangan) }}</textarea>
                                @error('keterangan')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex justify-end space-x-2 mt-6">
                            <a href="{{ route('admin.keluar-material.index') }}"
