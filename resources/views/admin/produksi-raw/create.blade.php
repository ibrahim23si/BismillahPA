{{-- resources/views/admin/produksi-raw/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Data Produksi Raw') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.produksi-raw.store') }}">
                        @csrf
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <span class="ml-2 text-sm font-medium" id="previewJam">0 jam</span>
                                </div>
                                <div>
                                    <span class="text-xs text-gray-500">Produktivitas per Jam:</span>
                                    <span class="ml-2 text-sm font-medium" id="previewProduktivitas">0 ton/jam</span>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            function hitungPreview() {
                ...
                if (jamMulai && jamSelesai) {
                    ...
                    // Jika jam selesai lebih kecil, berarti melewati tengah malam
                    if (selesai < mulai) {
