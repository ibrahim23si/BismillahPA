{{-- resources/views/admin/terima-raw/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Data Terima Raw') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.terima-raw.store') }}">
                        @csrf
                            ...
                            <div>
                                ...
                                <select name="nama_supplier" id="nama_supplier"
                                    ...
                                    @if(old('nama_supplier'))
                                        <option value="{{ old('nama_supplier') }}" selected>{{ old('nama_supplier') }}</option>
                                    @endif
                                </select>
                                @error('nama_supplier')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
