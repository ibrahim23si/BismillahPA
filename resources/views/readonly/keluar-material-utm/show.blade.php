{{-- resources/views/readonly/keluar-material-utm/show.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Detail Keluar Material UTM') }}
            </h2>
            <a href="{{ route('readonly.keluar-material-utm.index') }}"
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Informasi Keluar Material UTM -->
                        <div class="border rounded-lg p-4">
                            <h3 class="font-semibold text-lg mb-4 text-gray-700">Informasi Keluar Material UTM</h3>
                            <table class="w-full">
                                <tr>
