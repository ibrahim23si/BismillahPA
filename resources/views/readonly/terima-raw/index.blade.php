{{-- resources/views/readonly/terima-raw/index.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Data Terima Raw (Read Only)') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @include('readonly.partials.export-filter', ['exportRoute' => 'readonly.terima-raw.export'])
        ...
        <script>
            $(document).ready(function() {
                $('#terimaRawTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('readonly.terima-raw.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
